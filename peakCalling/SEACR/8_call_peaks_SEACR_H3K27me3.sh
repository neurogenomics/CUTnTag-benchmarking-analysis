...
## call peaks
SEACR_1.3.sh $root_dir/alignment/bedgraph/${sample_name}_rmDup_bowtie2.fragments.bedgraph $threshold non stringent $root_dir/peakCalling/SEACR/${sample_name}_rmDup_seacr_top${threshold}_peaks_TEST

SEACR_1.3.sh $root_dir/alignment/bedgraph/${sample_name}_withDup_bowtie2.fragments.bedgraph $threshold non stringent $root_dir/peakCalling/SEACR/${sample_name}_withDup_seacr_top${threshold}_peaks_TEST
