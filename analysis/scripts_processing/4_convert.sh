...
#samtools sort -n $root_dir/removeDuplicate/${sample_name}_bowtie2.sorted.${dup}.sam -o $root_dir/alignment/sam/${sample_name}_bowtie2.n_sorted.${dup}.sam
samtools sort -n $root_dir/alignment/sam/${sample_name}_bowtie2.sorted.${dup}.sam -o $root_dir/alignment/sam/${sample_name}_bowtie2.n_sorted.${dup}.sam
