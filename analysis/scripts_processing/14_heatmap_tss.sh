...
# plot heatmap
plotHeatmap --colorMap magma -m $root_dir/heatmap/transcription_units/matrix_gene_one_mate.mat.gz -out $root_dir/heatmap/transcription_units/heatmap_transcription_units_one_mate.png --sortUsing sum --samplesLabel $sample_1 $sample_2 "ENCODE_H3K27ac"
