...
```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE, fig.width=8, fig.height=4}
fragLen = c()
for(sample in sampleList){
...
```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE, fig.width=9, fig.height=3}
...
```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE, fig.width=9, fig.height=10}
peakAnnoList = lapply(peakList_with_ENCODE, annotatePeak, TxDb = TxDb.Hsapiens.UCSC.hg19.knownGene, tssRegion = c(-3000, 3000), verbose = FALSE)
